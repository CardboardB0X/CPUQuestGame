...
public enum EnemyType {
    CALCULATOR("Calc.exe", 1.0, 1.0, Color.LIGHT_GRAY, "Basic"),
    NOTEPAD("Notepad", 1.2, 1.1, new Color(200, 200, 255), "Text Editor"),
    CHROME("Chrome_Tab", 2.5, 1.5, Color.YELLOW, "RAM Hog"),
    VS_CODE("VS_Code", 2.0, 2.0, new Color(50, 150, 255), "Electron"),
    ANDROID("Android Studio", 4.0, 2.5, new Color(0, 150, 100), "Heavy"),
    PREMIERE("Adobe Premiere", 3.5, 3.0, new Color(150, 0, 150), "Rendering"),
    BLENDER("Blender Render", 5.0, 1.5, new Color(255, 100, 0), "Cycles"),
